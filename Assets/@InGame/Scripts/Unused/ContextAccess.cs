...
{
    public interface IDataContextForActor
    {
        public EvaluateState EvaluateState { get; }
        public void Init(uint? gene);
    }

    public interface IDataContextForState
    {

    }

    public interface IDataContextStatusRO
    {
        public Param Food { get; }
        public Param Water { get; }
        public Param HP { get; }
        public Param LifeSpan { get; }
        public Param BreedingRate { get; }
    }
